...
public class BookSearchTestNew {
    ...
    public void testSearchHarryPotter() {
        ...
        // Localizar o campo de pesquisa e realizar a busca
        ...
        // Aguardar e verificar se um dos resultados contém o título esperado
        WebElement firstResult = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[data-testid='book-search-item'] .SearchList_bookTitle__1wo4a")));
        ...
        WebElement author = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[data-testid='book-search-item'] .SearchList_bookAuthor__3giPc")));
